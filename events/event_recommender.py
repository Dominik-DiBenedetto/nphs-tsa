...
events = [
    ...
    {"name": "Hybrid Racer XL", "tags": ["engineering", "energy", "design"], "desc": "Hybrid Racer XL provides a hands-on opportunity for participants to apply science, technology, engineering, and mathematics (STEM) concepts - as well as leadership and 21st century skills such as creativity, teamwork, and problem-solving skills - as they design (according to annual requirements, if any), construct, and race a dual-powered (solar and battery) car."},
    ...
    {"name": "Automated Manufacturing Systems", "tags": ["technology", "automation", "engineering"], "desc": "Participants develop a solution to a problem (typically one from an industrial setting) presented onsite at the conference. They analyze the problem, build a computer-controlled mechanical model, program the model, demonstrate the programming and mechanical features of the model-solution in an interview, and provide instructions for evaluators to operate the model."},
